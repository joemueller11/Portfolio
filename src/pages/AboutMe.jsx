  ...
  return (
    <section>
      ...
      <p style={{ maxWidth: "800px", margin: "2rem auto", padding: "0 1rem" }}>
        "As a seasoned Computed Tomography Technologist, I bring a versatile skillset to the diagnostic imaging field, with demonstrated expertise across CT, Interventional Radiology (IR), and Radiography.
