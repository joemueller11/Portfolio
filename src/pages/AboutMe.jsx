function AboutMe() {
  return (
    <section>
      ...
      />
      <p>"As a seasoned Computed Tomography Technologist, I bring a versatile skillset to the diagnostic imaging field, with demonstrated expertise across CT, Interventional Radiology (IR), and Radiography.
         My career trajectory encompasses significant clinical and leadership experience within both U.S. Air Force and civilian healthcare environments. 
         ...
         My military background has cultivated a results-driven work ethic, unwavering discipline, and the capacity to excel in high-pressure environments. 
